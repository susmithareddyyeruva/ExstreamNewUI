...
public class AccountOwnerFragment extends Fragment implements OnBackPressed, View.OnClickListener {
    ...
    private boolean validations() {
        if (TextUtils.isEmpty(firstnameEdt.getText().toString())) {
            ...
            companyEdt.setError(getString(R.string.err_company_name));
            companyEdt.requestFocus();
            companyEdt.setEnabled(true);
            return false;
        } else if (TextUtils.isEmpty(mailingEdt.getText().toString())) {
            mailingEdt.setError(getString(R.string.err_mailing_name));
            mailingEdt.requestFocus();
            mailingEdt.setEnabled(true);
            return false;
        } else if (TextUtils.isEmpty(suite_unit_Edt.getText().toString())) {
            suite_unit_Edt.setError(getString(R.string.err_suite_unit_name));
            suite_unit_Edt.requestFocus();
            suite_unit_Edt.setEnabled(true);
            return false;
        } else if (TextUtils.isEmpty(zip_Edt.getText().toString())) {
            zip_Edt.setError(getString(R.string.err_zip));
            zip_Edt.requestFocus();
            zip_Edt.setEnabled(true);
            return false;
        } else if (TextUtils.isEmpty(cityEdt.getText().toString())) {
            cityEdt.setError(getString(R.string.err_city_name));
            cityEdt.requestFocus();
            cityEdt.setEnabled(true);
            return false;
        } else if (isEmptySpinner(spinnerState)) {
            ...
            spinnerState.requestFocusFromTouch();
